...
// pub struct CallAnalyzer<Ar: RegT> {
...
// pub fn is_table_size<Ar: RegT>(in_state: &CallCheckLattice<Ar>, memargs: &MemArgs<Ar>) -> bool {
...
// pub fn is_fn_ptr<Ar: RegT>(in_state: &CallCheckLattice<Ar>, memargs: &MemArgs<Ar>) -> Option<u32> {
...
// pub fn is_typeof<Ar: RegT>(in_state: &CallCheckLattice<Ar>, memargs: &MemArgs<Ar>) -> Option<X86Regs> {
